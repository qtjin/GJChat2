 ...
 * 实习圈评论
 */
public class MyNewsDetailCommentAdapter extends BaseAdapter {

    private Context context;
    public List<MyNewsDetailEntitiy.DataEntity.CommentListEntity> commentList;

    public MyNewsDetailCommentAdapter(Context context, List<MyNewsDetailEntitiy.DataEntity.CommentListEntity> commentList){
