 ...
 */
public class MyNewsGridViewAdapter extends BaseAdapter {

    private Context context;
    public List<MyNewsEntitiy.DataEntity.RowsEntity.ImageListEntity> imageList;
    private List<String> imgUrls;

    public MyNewsGridViewAdapter(Context context, List<MyNewsEntitiy.DataEntity.RowsEntity.ImageListEntity> imageList){
        this.context = context;
        this.imageList = imageList;
        imgUrls = new ArrayList<String>();
        for (MyNewsEntitiy.DataEntity.RowsEntity.ImageListEntity imageEntity:imageList) {
            String imgUrl="";
