package com.gj.gjchat2.huanxin.widget;
...
import com.gj.gjchat2.huanxin.adapter.EaseConversationAdapater;
...
public class EaseConversationList extends ListView {
    ...
    public void filter(CharSequence str,Filter.FilterListener filterListener) {
        //adapter.getFilter().filter(str);
        adapter.getFilter().filter(str, filterListener);
    }
