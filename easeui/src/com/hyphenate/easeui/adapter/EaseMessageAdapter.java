...
public class EaseMessageAdapter extends BaseAdapter{
	...
	public EaseMessageAdapter(Context context, String username, int chatType, ListView listView,int bgId) {
		this.context = context;
		this.listView = listView;
		this.bgId = bgId;
		toChatUsername = username;
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        case TXT:
            if(message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
                chatRow = new EaseChatRowBigExpression(context, message, position, this,bgId);
            }else{
                chatRow = new EaseChatRowText(context, message, position, this,bgId);
            }
            break;
        case LOCATION:
            chatRow = new EaseChatRowLocation(context, message, position, this, bgId);
            break;
        case FILE:
            chatRow = new EaseChatRowFile(context, message, position, this, bgId);
            break;
        case IMAGE:
            chatRow = new EaseChatRowImage(context, message, position, this, bgId);
            break;
        case VOICE:
            chatRow = new EaseChatRowVoice(context, message, position, this, bgId);
            break;
        case VIDEO:
            chatRow = new EaseChatRowVideo(context, message, position, this, bgId);
            break;
        default:
            break;
        }
