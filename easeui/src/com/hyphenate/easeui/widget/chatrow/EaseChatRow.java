...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter,int bgId) {
        super(context);
        this.context = context;
        this.activity = (Activity) context;
        this.message = message;
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            ...
            String userHead = HuanxinUserInfoCacheUtil.getCurrentUserHead(context);
            if(!TextUtils.isEmpty(userHead)){
                Field field = null;
                try {
                    field = drawable.getField(userHead);
                    int r_id = field.getInt(field.getName());
                    userAvatarView.setImageResource(r_id);
